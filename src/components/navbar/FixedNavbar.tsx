  ...
  return (
    <header className="z-[999] relative">
      <motion.div
        ...
        className="fixed top-0 left-1/2 h-[4.5rem] w-full rounded-none border border-[#F8EFE4] border-opacity-40 bg-[#F8EFE4] bg-opacity-80  backdrop-blur-[0.5rem] sm:top-6 sm:h-[3.25rem] sm:w-[36rem] sm:rounded-full dark:bg-[#0D0B0D] dark:border-[#040404]/40 dark:bg-opacity-75"
