...
export function DescN3Teamwork(props) {
  const { nodes, materials } = useGLTF('./models/text/desc-n3teamwork-transformed.glb')
  ...
  return (
    <group {...props} dispose={null} ref={model3d}>      
      <mesh geometry={nodes.teamwork.geometry} material={nodes.teamwork.material} position={[0, 0, 0]} rotation={[1*Math.PI/2, 0, 0]} scale={[1, 1, 1]}/>
    </group>
  )
}

useGLTF.preload('./models/text/desc-n3teamwork-transformed.glb')
