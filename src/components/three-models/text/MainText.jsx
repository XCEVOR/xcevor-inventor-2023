...
export function MainText(props) {
  ...
  useLayoutEffect(()=> {
    ...
    .to(myxxxRef.current.position, {z: 1.5}, 0)
    ...
    // .to(myxxxRef.current.rotation, {y: 0}, 16)   
    // .to(myxxxRef.current.rotation, {x: 0}, 16) 
    // .to(myxxxRef.current.position, {x: 0}, 16)    

    // .to(myxxxRef.current.rotation, {y: 0}, 20)   
