...
export function DecoShuttle(props) {
  ...
  useLayoutEffect(()=> {
    ...
    tl.current
    .to(robot.current.position, {x: -0.5}, 1)
    .to(robot.current.position, {y: 0.000001}, 3)
    .to(robot.current.position, {z: 2.5}, 1)
    .to(robot.current.rotation, {x: -Math.PI/2}, 1)
    .to(robot.current.rotation, {z: Math.PI/6}, 1)
    // .to(robot.current.rotation, {y: Math.PI/2}, 0)

    .to(robot.current.position, {x: 3.5}, 3)
    .to(robot.current.position, {y: 0.0000001}, 3)
    .to(robot.current.position, {z: 0.5}, 3)
    .to(robot.current.rotation, {z: Math.PI/1.5}, 1)
