...
const Menu = () => {
  ...
  return (
    <div>
      ...
      {open && <div className="bg-[#ffbf11] text-white absolute left-0 top-24 w-full h-full h=[calc(100vh-3rem)] flex flex-col gap-8 items-center justify-center text-3xl z-10">
        {links.map((link) => (
