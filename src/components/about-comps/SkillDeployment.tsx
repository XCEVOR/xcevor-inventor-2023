...
const SkillDeployment = async () => {
  ...
  return (
    ...
    <div className='w-full'>
      <div className='flex flex-col p-8 bg-[#0A0A0A]/80 backdrop-blur rounded-xl'>
        <h1 className='flex justify-center text-2xl font-bold mb-4'>Deployment</h1>
        ...
        {fetchedSkillData.map((sdata, index) => (
          <div key={index} className="flex flex-row relative max-w-500 m-2 p-4 border border-[#F8EFE4] border-opacity-20 rounded-lg  transition hover:-translate-y-1">
